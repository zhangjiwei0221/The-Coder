...
export const EVENTS_LIST = [
  ...
  {icon:'📦',title:'未知包裹',desc:'一个来历不明的npm包...安装它？',choices:[{text:'安装 (随机获得1张牌)',action(r){const p=['atk','def','heal','poison','burn','for_loop','if_atk2','p5','p7'];r.deck.push({id:newCardId(),defId:pick(p)});}},{text:'太危险了',action(){}}]},
